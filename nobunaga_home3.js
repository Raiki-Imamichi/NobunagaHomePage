...
$("#ranger").change(function () {
  ...
  if ($("#ranger").val() < 3) {
    $(".pricing-card").removeClass(
      "active-1 active-2 active-3 active-4 display-hidden"
    );

    $(".pricing-card").addClass("active-9 active-1");
  ...
  } else if ($("#ranger").val() > 11 && $("#ranger").val() < 30) {
    $(".pricing-card").removeClass("active-1 active-2 active-3 active-4");
    $(".pricing-card").addClass("active-3 display-hidden");
  } else if ($("#ranger").val() > 31 && $("#ranger").val() < 50) {
    $(".pricing-card").removeClass("active-1 active-2 active-3 active-4");
...
$("#ranger2").change(function () {
  ...
  if ($("#ranger2").val() <= 0) {
    $(".pricing-card").removeClass(
      "active-9 active-10 active-11 active-12 active-13 display-hidden"
    );
    ...
    $(".pricing-card").addClass("active-12 display-hidden");
  } else if ($("#ranger2").val() > 76 && $("#ranger2").val() < 100) {
    $(".pricing-card").removeClass(
      "active-9 active-10 active-11 active-12 active-13"
    );
    $(".pricing-card").addClass("active-13 display-hidden");
  }
});
